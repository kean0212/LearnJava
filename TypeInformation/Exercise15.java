...
class Mutt extends Dog {
    ...
    public static class Factory implements GenericFactory<Mutt> {
        public Mutt create() {
            return new Mutt();
        }
    }
...
class Pug extends Dog {
    ...
    public static class Factory implements GenericFactory<Pug> {
        public Pug create() {
            return new Pug();
        }
    }
...
class EgyptianMau extends Cat {
    ...
    public static class Factory implements GenericFactory<EgyptianMau> {
...
class Manx extends Cat {
    ...
    public static class Factory implements GenericFactory<Manx> {
        public Manx create() {
            return new Manx();
        }
    }
...
class Cymric extends Manx {
    ...
    public static class Factory implements GenericFactory<Cymric> {
...
class Rat extends Rodent {
    ...
    public static class Factory implements GenericFactory<Rat> {
        public Rat create() {
            return new Rat();
        }
    }
...
class Mouse extends Rodent {
    ...
    public static class Factory implements GenericFactory<Mouse> {
        public Mouse create() {
            return new Mouse();
        }
    }
...
class Hamster extends Rodent {
    ...
    public static class Factory implements GenericFactory<Hamster> {
...
class RegisteredFactories {
    private static List<GenericFactory<? extends Pet>> allTypes = new ArrayList<GenericFactory<? extends Pet>>();

    static {
        allTypes.add(new Mutt.Factory());
        allTypes.add(new Pug.Factory());
        allTypes.add(new EgyptianMau.Factory());
        allTypes.add(new Cymric.Factory());
        allTypes.add(new Manx.Factory());
        allTypes.add(new Rat.Factory());
        allTypes.add(new Mouse.Factory());
        allTypes.add(new Hamster.Factory());
    }

    private static final Random random = new Random(212);

    public Pet randomPet() {
        int index = random.nextInt(allTypes.size());
        return allTypes.get(index).create();
    }
...
// this is the facade
class Pets {
    public static final RegisteredFactories creator = new RegisteredFactories();
