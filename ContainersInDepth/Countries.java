...
public class Countries {
    ...
    public static void main(String[] args) {
        Util.print(capitals(10));
        Util.print(names(10));
        Util.print(new HashMap<String, String>(capitals(3)));
        Util.print(new LinkedHashMap<String, String>(capitals(3)));
        Util.print(new TreeMap<String, String>(capitals(3)));
        Util.print(new Hashtable<String, String>(capitals(3)));
        Util.print(new HashSet<String>(names(6)));
        Util.print(new LinkedHashSet<String>(names(6)));
        Util.print(new TreeSet<String>(names(6)));
        Util.print(new ArrayList<String>(names(6)));
        Util.print(new LinkedList<String>(names(6)));
        Util.print(capitals().get("BRAZIL"));
    }
} /* Output:
